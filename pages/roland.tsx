...
import SearchResultsRoland from '../components/roland/SearchResultsRoland';
import GenerativeAnswerWrapperRoland from '../components/roland/GenerativeAnswersWrapperRoland';

const config: HeadlessConfig = {
  apiKey: 'b083465ee2ad3d23460e150c6a297f7f',
  experienceKey: 'roland-demo',
  locale: 'en',
  verticalKey: 'content',
};
...
export default function Roland(): JSX.Element {
              ...
              <div className="w-full flex flex-col items-center">
                <div className="w-full max-w-3xl flex flex-col">
                  <SearchBar
                    ...
                    placeholder="Ask a question about your Roland products..."
                  />
                  <SpellCheck />
                </div>
                {currentQuery && (
                    ...
                    {verticalResults &&
                      ...
                      currentQuery && (
                        <>
                          ...
                          <SearchResultsRoland results={verticalResults} />
                        </>
                      )}
                  </section>
                </motion.div>
