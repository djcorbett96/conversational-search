...
import GenerativeAnswerWrapperCNO from '../components/cno/GenerativeAnswerWrapperCNO';
import SearchResultsCNO from '../components/cno/SearchResultsCNO';

const config: HeadlessConfig = {
  apiKey: 'fb4473840b416fbc047b87809ce08fdc',
  experienceKey: 'bankers-life-search',
  locale: 'en',
  verticalKey: 'files',
...
const chatConfig: ChatConfig = {
  apiKey: '54e7055ff45f6d60adfee6259677226c',
  botId: 'demo---agent-search',
};
                    ...
                    {verticalResults &&
                      ...
                      currentQuery && (
                        <>
                          ...
                          <SearchResultsCNO results={verticalResults} />
                        </>
                      )}
                  </section>
                </div>
