...
import GenerativeAnswerWrapperMerrill from '../components/merrill/GenerativeAnswerWrapperMerrill';
import SearchResultsMerrill from '../components/merrill/SearchResultsMerrill';

const config: HeadlessConfig = {
  apiKey: '35882d38645c9ebd9c63ff5a25a65553',
  experienceKey: 'merrill-demo',
  locale: 'en',
  verticalKey: 'vectorDocuments',
};

const chatConfig: ChatConfig = {
  apiKey: '2ed66ef78e526b6f2198f693aced2bb5',
  botId: 'merrill-bot',
};

export default function Merrill(): JSX.Element {
                  ...
                  >
                    <div className="max-w-3xl py-10 w-full">
                      {answer && !generatingAnswer && (
                        <GenerativeAnswerWrapperMerrill
                    ...
                    {verticalResults &&
                      ...
                      currentQuery && (
                        <>
                          ...
                          <SearchResultsMerrill results={verticalResults} />
                        </>
                      )}
                  </section>
                </div>
